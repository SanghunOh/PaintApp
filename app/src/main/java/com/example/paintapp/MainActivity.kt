            ...
            if (p0 == null)
                ...
                okHttpClient.newCall(request).enqueue(object : Callback {
                    override fun onResponse(call: Call, response: Response) {
                        ...
                        questionTextView.text = this@MainActivity?.getString(R.string.app_gpt_question, prompt) ?: ""
                        questionBarTextView.text = this@MainActivity?.getString(R.string.app_gpt_question, prompt) ?: ""
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        runOnUiThread {
                            Popup.show(prompt, "Something Wrong!! Please try again...")
                        }
                    }
                })
            }
